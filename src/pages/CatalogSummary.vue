<template>
    <div class="contract-wrap" :style="{width: 'calc(100% - '+sidebarW+'px)'}">
        ...
        <el-table class="el-table-box" :data="tableData" :max-height="tableH" :border="true" :stripe="true">
            ...
            <el-table-column prop="aa" label="aa" :align="'center'"></el-table-column>
            <el-table-column prop="bb" label="bb" :align="'center'"></el-table-column>
            <el-table-column prop="bbc" label="bbc" :align="'center'"></el-table-column>
            <el-table-column prop="cc" label="cc" :align="'center'"></el-table-column>
            <el-table-column prop="dd" label="dd" :align="'center'"></el-table-column>
            <el-table-column prop="ee" label="ee" :align="'center'"></el-table-column>
            <el-table-column prop="ff" label="ff" :align="'center'"></el-table-column>
            <el-table-column prop="allOrgNumber" label="合计"></el-table-column>
        </el-table>
...
export default {
    ...
    setup(props, context) {
        ...
        const routeType = ref('/catalogSummary');
